...
<body class="is-preload">
    <div id="page-wrapper">
        ...
        <section id="main" class="container medium">
            <header>
                <h2>Abrir Ticket Supermecado Kauan</h2>
            ...
            <div class="box">
                <form method="get" action="tickets.php">
                    <div class="row gtr-50 gtr-uniform">
                        <div class="col-12">
                            <label>Escolha a Filial: </label><br />
                            <label for="A">Tarauacá</label>
                            <input type="radio" name="enterprise" value="SKTK"/><br />
                            <label for="M">Rio Branco</label>
                            <input type="radio" name="enterprise" value="SKRB"/><br />
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <ul class="actions special">
                                <li><input type="button" id="submit" value="Solicitar Chamado" /></li>
                            </ul>
                        </div>
                    </div>
                </form>
